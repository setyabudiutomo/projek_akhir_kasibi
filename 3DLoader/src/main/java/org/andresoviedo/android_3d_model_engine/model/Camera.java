...
public class Camera {
	...
	public static final float STRAFE_LEFT = -0.5f; // Left straft
	public static final float STRAFE_RIGHT = 0.5f; // Right straft speed. 0.5f
	...
	public Camera() {
		...
		this(0, 1, 2.5f, 0, 1, 0, 0, 5, 0);
		//this(0, 0, 6, 0, 0, -1, 0, 1, 0);//aslinya
	}
